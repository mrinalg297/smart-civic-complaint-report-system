            ...
            <div className="flex-1 flex items-center justify-center p-4 pt-32">
                <div className="w-full max-w-md bg-white p-8 rounded-2xl border border-[#E8E0D4] shadow-sm transform transition-all duration-300">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-[#1C1C1E] mb-2" style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800 }}>Welcome</h1>
                        <p className="text-[#6B6B6B] text-sm" style={{ fontFamily: "'DM Sans', sans-serif" }}>Create your account to start reporting issues</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        >
                            Sign Up <span className="ml-2 font-mono">→</span>
                        </button>
                    </div>

                    <div className="mt-8 text-center text-sm text-[#6B6B6B]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                        Already have an account? <a href="/login" className="font-bold hover:underline" style={{ color: "#F5A623" }}>Sign in</a>
                    </div>
                </div>
            </div>
            <FooterSection />
